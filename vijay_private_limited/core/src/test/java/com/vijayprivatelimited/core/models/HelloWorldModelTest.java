 ...
 */
package com.vijayprivatelimited.core.models;
...
import com.vijayprivatelimited.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "vijay_private_limited/components/helloworld");
